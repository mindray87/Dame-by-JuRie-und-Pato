...
class GridSpec extends WordSpec with Matchers {
  "A Grid is the playingfield of Draught. A Grid" when {
    ...
    "print the numbers of each gridcell" in {
      ...
      controll.getCoordinates(p1.getPiece(5)) should be (0, 0)
      controll.getCoordinates(null) should be (-1,-1)
      controll.getPiece(5,5) should be (null)
      controll.getPiece(0,0) should be (Piece(1,PieceType.Men))
    }
  }
}
