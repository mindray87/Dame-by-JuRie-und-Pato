...
class GridSpec extends WordSpec with Matchers {
  "A Grid is the playingfield of Draught. A Grid" when {
    ...
    "print the numbers of each gridcell" in {
      ...
      controll.grid.getCoordinates(p1.getPiece(5)) should be (0, 0)
      controll.grid.getCoordinates(null) should be (-1,-1)
      controll.grid.getPiece(5,5) should be (null)
      controll.grid.getPiece(0,0) should be (Piece(1,PieceType.Men))
    }
  }
}
